...
\end{align}
The above formulas were taken from the lecture notes. The function calculating this is written at \path{optimal_SOR_parameter_asym}. \textbf{MISSING ADDITIONAL CONTEXT}
...
\begin{figure}[H]
    \centering
    \subfloat[]{\includegraphics[width=0.4\textwidth]{fig31.png}\label{fig:fig31}}\hfill
    \subfloat[]{\includegraphics[width=0.4\textwidth]{fig32.png}\label{fig:fig32}}
...
\begin{figure}[H]
    \centering
    \subfloat[]{\includegraphics[width=0.4\textwidth]{fig41.png}\label{fig:fig41}}\hfill
    \subfloat[]{\includegraphics[width=0.4\textwidth]{fig42.png}\label{fig:fig42}}
...
\begin{figure}[H]
    \centering
    \subfloat[$u_x$]{\includegraphics[width=0.4\textwidth]{fig71x.png}\label{fig:fig71x}}\hfill
    \subfloat[$u_x$]{\includegraphics[width=0.4\textwidth]{fig72x.png}\label{fig:fig72x}}

    \subfloat[$u_y$]{\includegraphics[width=0.4\textwidth]{fig71y.png}\label{fig:fig71y}}\hfill
    \subfloat[$u_y$]{\includegraphics[width=0.4\textwidth]{fig72y.png}\label{fig:fig72y}}
...
\begin{figure}[H]
    ...
    \subfloat[Heatmap of vector magnitudes]{\includegraphics[width=0.33\textwidth]{fig82.png}\label{fig:fig82}}
    \subfloat[Contour map of vector magnitudes]{\includegraphics[width=0.33\textwidth]{fig83.png}\label{fig:fig83}}\hfill
...
\begin{figure}[H]
    \centering
    \subfloat[]{\includegraphics[width=0.49\textwidth]{fig10comp.png}\label{fig:fig10comp}}\hfill
    \subfloat[]{\includegraphics[width=0.49\textwidth]{fig10phys.png}\label{fig:fig10phys}}
...
\end{align}
Using these finite differences, Gauss-Seidel iteration was applied, solving for $x_{i,j}$ and $y_{i,j}$ each time (despite it not being a linear problem). Function for solving this written at \path{gauss_seidel_xy_C}. \textbf{TODO: maybe add in proof of convergence with careful error control and showing that the errors don't grow.}
...
\begin{align}
    ...
    f'(x) = \frac{f(x) - 4f(x-h) + 3f(x-2h)}{2h} + O(h^2) 
\end{align}
Thus, we can use Gauss-Seidel iteration (Function written at \path{gauss_seidel_method_C}) applied to the linear PDE.
